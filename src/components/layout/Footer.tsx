...
import { Facebook, Instagram, Youtube, Phone, Mail, MapPin, Heart, LogIn } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-secondary to-secondary/80 flex items-center justify-center shadow-md">
                <span className="text-xl font-serif font-bold text-primary">A</span>
              </div>
              <div>
                <h3 className="font-serif font-bold text-lg">AUSDAV</h3>
                <p className="text-xs text-primary-foreground/70">Est. 2015</p>
              </div>
            </div>
            ...
            <div className="flex gap-2 pt-2">
              <Button asChild variant="footerDonate" size="sm">
                <Link to="/donate">
                  <Heart className="w-4 h-4 mr-1" />
                  {t('nav.donate')}
                </Link>
              </Button>
              <Button asChild variant="footerLogin" size="sm">
                <Link to="/login">
          ...
          {/* Social */}
          <div>
            <h4 className="font-serif font-semibold text-lg mb-4">{t('footer.followUs')}</h4>
